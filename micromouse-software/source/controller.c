...
void MOVE_CONTROLLER(sMOUSE *mouse)
{
	...
	out 		= 1.0f * mouse->distance_to_travel 	 	+ 1.0f 	* (mouse->distance_to_travel - prev_distance_to_travel) / TIME_STAMP;
	out_ang = 1.0f 	* mouse->ang_to_achieve + 1.0f * (mouse->ang_to_achieve - prev_ang_to_achieve) / TIME_STAMP;
